...
public class EventoController {
    ...
    @PutMapping("/{id}")
    public Evento actualizar(@PathVariable long id, @RequestBody EventoUpdateRequest request) {
        ...
        int capacidad = request.capacidadMaxima() > 0 ? request.capacidadMaxima() : 20;
        String descripcion = request.descripcion() == null ? "" : request.descripcion().trim();
        return eventoService.actualizar(id, request.fecha(), request.hora(), lugar.trim(), descripcion, capacidad);
    }
    ...
    public record EventoUpdateRequest(LocalDate fecha, LocalTime hora, String lugar, String descripcion, int capacidadMaxima) {}
